    ...
    attach: function (context) {
        ...
        $(document).ready(function() {
            ...
            $("#pto_venta_region").change(function(){
                ...
                for (i=0;i<ciudades[region].length;i++){
                    if (region == ciudades[region][i][0] ){
                        select_rg = select_rg + "<option value='"+ciudades[pais][i][1]+"'>"+ciudades[pais][i][1]+"</option>";
                    }
                }

                $("#pto_venta_ciudad").html(select_rg);
            ...
            $("#pto_venta_ciudad").change(function(){
                ...
                for (i=0;i<sucursales[pais].length;i++){
                    if (select_ciudad == sucursales[pais][i][1] ){
                        select_rg = select_rg + "<option value='"+sucursales[pais][i][0]+"'>"+sucursales[pais][i][0]+"</option>";
                    }
                }
