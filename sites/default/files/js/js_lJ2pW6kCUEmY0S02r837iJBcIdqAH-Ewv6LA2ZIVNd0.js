...
(function($){
  Drupal.behaviors.some_name = {
    attach: function (context) {
        ...
        sucursales['argentina'] = ["Mendoza",
             ['empresa', "Tas Choapa"]
            ,['direccion1', "Autopista de Acceso Este S/N"]
            ,['direccion2', "Terminal del Sol, Locales E6-E7"]
            ,['latitud', "-32,894689"]
            ,['longitud', "-68,829421"]
            ,['horario', "L-D 07:00-22:30 hrs"]
            ,['telefono', "+54 2 61431 2140"]
        ];

        sucursales['chile'] = ["Santiago",
             ['empresa', "Tas Choapa"]
            ,['direccion1', "Terminal de Buses Sur, Oficina 70"]
            ,['direccion2', "Terminal de Buses Sur, Oficina 70"]
            ,['latitud', "-33,453968"]
            ,['longitud', "-70,687867"]
            ,['horario', "L-D 07:30-22:15 hrs"]
            ,['telefono', "+56 2 2822 7561"]
        ];

        document.write(sucursales['chile']['Santiago']['telefono']);
