  ...
  Drupal.behaviors.some_name = {
    attach: function (context) {
        ...
        var map = new google.maps.Map(document.getElementById('map'), {
          zoom: 10,
          center: new google.maps.LatLng(-33,453398,-70,687077),
            ...
            $("#pto_venta_ciudad").change(function(){
                ...
                for (i=0;i<sucursales[pais].length;i++){
                    if(ciudad == sucursales[pais][i][0] ){
                        console.log(sucursales[pais][i][4]);
                        //select_ciudad = select_ciudad + "<option value='"+sucursales[pais][i][0]+"'>"+sucursales[pais][i][0]+"</option>";
                        marker = new google.maps.Marker({
                            position: new google.maps.LatLng(sucursales[pais][i][4], sucursales[pais][i][5]),
                            map: map
                        });
