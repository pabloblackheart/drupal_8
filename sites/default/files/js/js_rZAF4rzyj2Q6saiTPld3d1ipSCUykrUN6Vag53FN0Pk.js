...
(function($){
  Drupal.behaviors.some_name = {
    attach: function (context) {
        ...
        var sucursales['argentina'] = [];
        var sucursales['chile']     = [];

        sucursales['argentina']['empresa']    = "Tas Choapa";
        sucursales['argentina']['ciudad']     = "Mendoza";
        sucursales['argentina']['direccion1'] = "Autopista de Acceso Este S/N";
        sucursales['argentina']['direccion2'] = "Terminal del Sol, Locales E6-E7";
        sucursales['argentina']['latitud']    = "-32,894689";
        sucursales['argentina']['longitud']   = "-68,829421";
        sucursales['argentina']['horario']    = "L-D 07:00-22:30 hrs";
        sucursales['argentina']['telefono']   = "+54 2 61431 2140";

        sucursales['chile']['empresa']    = "Tas Choapa";
        sucursales['chile']['ciudad']     = "Santiago";
        sucursales['chile']['direccion1'] = "Terminal de Buses Sur, Oficina 70";
        sucursales['chile']['direccion2'] = "Terminal de Buses Sur, Oficina 70";
        sucursales['chile']['latitud']    = "-33,453968";
        sucursales['chile']['longitud']   = "-70,687867";
        sucursales['chile']['horario']    = "L-D 07:30-22:15 hrs";
        sucursales['chile']['telefono']   = "+56 2 2822 7561";
